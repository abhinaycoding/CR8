...
export default function WorkPage() {
  ...
  return (
    <div className="w-full bg-[#0B0D0A] text-[#FAFAF7] min-h-screen">
      ...
      {/* ── PAGE HEADER ── */}
      <section className="w-full pt-36 pb-10 px-6 lg:px-16 border-b border-[#1E1E1E]">
      ...
      {/* ── FILTER BAR ── */}
      <div className="w-full px-6 lg:px-16 py-5 border-b border-[#1E1E1E] bg-[#0B0D0A] sticky top-0 z-20">
